...
export const PRIMITIVES = Object.keys(BSONXTypes).filter((key) => BSONXTypes[key].type === "primitive");

export const ARRAYS = Object.keys(BSONXTypes).filter((key) => BSONXTypes[key].type === "array");

export const ERRORS = Object.keys(BSONXTypes).filter((key) => BSONXTypes[key].type === "error");